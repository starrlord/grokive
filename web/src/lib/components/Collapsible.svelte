...
<div class="mb-4">
  <button type="button" class="collapsible-title flex w-full items-center justify-between gap-2 py-2 text-xs font-bold uppercase tracking-wider text-muted transition hover:text-ink" aria-expanded={open} aria-controls={cid} onclick={() => (open = !open)}>
